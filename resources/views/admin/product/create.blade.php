                                    ...
                                    <form   action="{{ url('admin/product') }}" method="Post" enctype="multipart/form-data">
                                       @csrf
                                        <div class="row">
                                                ...
                                                <input type="text" name="p_name" class="form-control" id="floatingnameInput" placeholder="Enter Name">
                                                <label for="floatingnameInput">Product Name</label>
                                            </div>
                                                </div>
                                                <div class="col-md-6">
                                                <div class="form-floating mb-3">
                                                <input type="text" name="p_slug" class="form-control" id="floatingnameInput" placeholder="Enter Name">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                <div class="form-floating mb-3">
  <textarea class="form-control" placeholder="Enter the product description here" id="floatingTextarea2" style="height: 100px" name="p_desc"></textarea>
  <label for="floatingTextarea2">Product Description</label>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <input type="number" name="p_price" class="form-control" id="floatingemailInput" placeholder="Enter Email address">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <input type="number" name="p_sort_order" class="form-control" id="floatingemailInput" placeholder="Enter Email address">
